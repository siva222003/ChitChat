...
const names = [
  "John Doe", "Alice Smith", "Bob Johnson", "Eve Brown", "Charlie Davis", 
  "Grace Wilson", "Henry Miller", "Ivy Clark", "Jack Lee", "Kate Adams", 
  "Liam Green", "Mia Hall", "Noah Hill", "Olivia King", "Peter Scott", 
  "Queen Taylor", "Ryan Lopez", "Sara Martin", "Tom White", "Uma Young", 
  "Victor Carter", "Wendy Harris", "Xander Robinson", "Yara Patel", 
  "Zoe Hughes", "Amy Evans", "Bill Turner", "Cathy Baker", "David Cook", 
  "Emily Allen", "Frank Wright"
];

const content = [
  "Hey there!", "It's so quiet outside", "How are you?", "Good morning!", 
  "What's up?", "Nice to meet you", "Looking forward to it", "Have a great day", 
  "Let's catch up soon", "Just checking in", "Sending my regards", 
  "Hoping to see you soon", "Thinking of you", "Wishing you well", 
  "Congratulations!", "You're awesome!", "Keep in touch", "Best wishes", 
  "Stay safe and healthy", "Miss you!","Hey there!", "It's so quiet outside", "How are you?", "Good morning!", 
  "What's up?", "Nice to meet you", "Looking forward to it", "Have a great day", 
  "Let's catch up soon", "Just checking in", "Sending my regards", 
  "Hoping to see you soon", "Thinking of you", "Wishing you well", 
  "Congratulations!", "You're awesome!", "Keep in touch", "Best wishes", 
  "Stay safe and healthy", "Miss you!"
];
...
export const contacts = names.map((name, index) => {
  return {
    name: name,
